...
function ForgetPassword() {
  return (
    <>
      <div class="min-h-screen bg-[url(https://img.freepik.com/premium-photo/travel-collage-with-white-background_123891-34614.jpg?w=2000)] flex items-center justify-center">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-md w-full">
        ...
        <form>
            ...
            <button class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full" type="submit">
                Reset Password
            </button>
        </form>
    </div>
